...
async function getSongs(folder) {
    ...
    // here as is ancer tag which contains songs
    ...
    for (let index = 0; index < as.length; index++) {
        ...
        // attach an event Listener to each song in the play list
...
async function main() {
    ...
    // attach an event listener to play, next, previous buttons in playBar
    ...
    // load playlist when clicked on the card
